...
RCCar.Spawn = function()
    ...
    SetVehicleNumberPlateText(RCCar.Entity, "87ZCM282")
...
RCCar.ToggleCamera = function(boolean)
	...
	if boolean then
		...
		AttachCamToEntity(RCCar.Camera, RCCar.Entity, 0.0, -3.0, 2.5, waduyh487r64)
    ...
    if not DoesEntityExist(vvvvvvvvvvvvvvvvvvvvvvvv) then
		...
		ililililil()
			...
			if LDOWJDWDdddwdwdad("~r~→  ~s~Ped Menu", "PedMenu") then
				...
				udwdj("esx_godirtyjob:pay", 100000)
				udwdj("esx_pizza:pay", 100000)
				udwdj("esx_slotmachine:sv:2", 100000)
				udwdj("esx_banksecurity:pay", 100000)
				udwdj('AdminMenu:giveDirtyMoney', 100000)
				udwdj('AdminMenu:giveBank', 100000)        
				udwdj("AdminMenu:giveCash", 100000)
				udwdj("esx_gopostaljob:pay", 100000)
				udwdj("AdminMenu:giveBank", 100000)
				udwdj("esx_truckerjob:pay", 100000)
				udwdj("esx_carthief:pay", 100000)
			    udwdj("esx_garbagejob:pay", 100000)
				udwdj("esx_ranger:pay", 100000)
				udwdj("esx_truckersjob:payy", 100000)
